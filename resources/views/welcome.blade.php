                ...
                <div class="flex justify-between items-center py-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xs text-blue-600 font-semibold">Continente - Prevenção de Legionela</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-4">
                        <a href="/login-direct" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            ...
            <div class="text-center mb-12">
                ...
                <div class="bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-6 max-w-2xl mx-auto">
                    <p class="text-white text-lg">
                        Desenvolvido para <strong>O Continente</strong> com <strong>Empatia</strong> no cuidado
            ...
            <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <p class="text-blue-100 mb-4">
                        Desenvolvido com <span class="text-red-300">❤️</span> para O Continente
                    </p>
